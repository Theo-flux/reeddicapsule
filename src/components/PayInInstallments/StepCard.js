...
export default function StepCard({ step }) {
  ...
  return (
    <div
      className={`flex flex-col gap-y-8 items-center md:flex-${direction} justify-between items-center`}
    >
      <div className="flex flex-col p-4 gap-y-2 bg-[#fff] rounded-md shadow-lg md:w-[45%]">
        <span className="w-fit bg-[#53CD8B] text-[#fff] text-sm rounded py-1 px-2.5 font-medium">
          {id}
        </span>
