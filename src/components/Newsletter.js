...
export default function Newsletter() {
  return(
      <section style={{ background: `linear-gradient(112.47deg, #F8FCFA -17.2%, rgba(224, 255, 227, 0.02) 114.3%)`}}>
        <div className='w-11/12 mx-auto my-8 lg:my-16 max-w-7xl'>
          <div className='w-full flex flex-col justify-center items-center py-14 lg:py-20 gap-y-16 max-w-[700px] mx-auto'>
